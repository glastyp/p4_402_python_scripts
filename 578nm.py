...
plt.title("Kennlinie für $578\,\mathrm{nm}$; 1. Messung",
          y=1.08)
...
plt.ylim(I[-1]-0.5,I[0]+1)

plt.grid(True, zorder=0)

fig_U.savefig("578nm1.pdf")

""" 2 """

data = open("578nm2.txt", 'r')
lines=data.readlines()
I=[]
dI=[]
U_G=[]
...
plt.title("Kennlinie für $578\,\mathrm{nm}$; 2. Messung nach neuer Justage",
          y=1.08)
plt.xlabel("$U_\mathrm{G}/\,\mathrm{mV}$")
plt.ylabel("$\sqrt{I-I_0}/\,\sqrt{\mathrm{V}}$")
