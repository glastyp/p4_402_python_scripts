...
plt.title("Kennlinie für $546\,\mathrm{nm}$; 1. Messung",
          y=1.08)
...
plt.ylim(I[-1]-1,I[0]+1)

plt.grid(True, zorder=0)

fig_U.savefig("546nm1.pdf")

""" 2 """

data = open("546nm2.txt", 'r')
lines=data.readlines()
I=[]
dI=[]
U_G=[]
...
plt.title("Kennlinie für $546\,\mathrm{nm}$; 2. Messung",
          y=1.08)
plt.xlabel("$U_\mathrm{G}/\,\mathrm{mV}$")
plt.ylabel("$\sqrt{I-I_0}/\,\sqrt{\mathrm{V}}$")
